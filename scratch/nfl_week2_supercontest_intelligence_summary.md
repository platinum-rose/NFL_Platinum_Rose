...
## 0. Week 1 Card Review (what we carry forward)

| Pick | Result | Final |
|---|---|---|
| TB +3.5 @ CIN | ❌ Loss | CIN 33–27 (lost by 6) |
| IND +3.5 vs BAL | ❌ Loss | BAL 41–23 |
| PIT −3.5 vs ATL | ✅ Win | PIT 20–13 (covered by 3.5 — the one +2.0 CLV pick) |
| DAL −3.0 @ NYG | ❌ Loss | NYG 28–20 |
| CAR +3.0 vs CHI | ❌ Loss | CHI 59–37 |

**1–4 (1.0 pt).** Four of the five leaned on "crosses the key number 3" hook logic; the only winner was the pick that had **real closing-line value** (PIT −3.5 when the market went to −5.5). Week 2 rule: rank contest picks first by **contest-line vs. market gap** and consensus, and only then by key-number/hook narratives.

TNF (DET @ BUF, contest BUF −4.5) is settled: **BUF 41–31, Bills covered.** 15 games remain.

---

## 1. Executive Ranked Recommendations — The Platinum Rose "Top 5"
...
## 2. Complete 15-Game SuperContest ATS Matrix
...
## 3. Expert Panel Contest Board (Week 2 spread picks, Sep 14+)

| Panel | Sides on the Sun/Mon slate |
|---|---|
| **Even Money (Ross Tucker & Steve Fezzik)** | MIN +5.5, NYJ +3.5/+4.5, ARI +4.5, WAS +3.5, HOU −2.5, DEN −2.5, LV +7. Teaser legs: BAL −2.5, TB −2.5, LAR −1, JAX +8.5, ATL +7.5. Fezzik's five (via Ross Tucker Pod): BUF −4.5 ✅, NYJ +3.5, HOU −2.5, DEN −2.5, ARI +4.5 |
| **Sharp or Square (Simon Hunter & Chad Millman)** | LAR −7, PHI −7/−6.5, MIA +13.5, PIT +5.5, ARI +4/+4.5, NYJ +4.5, WAS +3.5, HOU −2.5, DEN −2.5, NO +8.5, LV +7, IND +6.5, ATL +2 |
| **Action Network** | MIN +4.5, LAR −7, DEN −2.5, HOU −2.5, TB −8.5, BAL −8.5, MIA +13.5, NYJ +4.5, NE −4.5, SEA −3.5, PHI −6.5, DAL −3.5, IND +6.5/+7, ATL +1.5 |
...
## 4. Game-by-Game Spread-Only Dossier (Sun/Mon)

**MIN @ CHI (CHI −5.5 contest / −4.5 market, total 48).** Kyler Murray OUT (concussion) → Carson Wentz, named Friday. Jauan Jennings OUT. Bears: S Anthony Johnson Jr. OUT, slot CB Kyler Gordon on PUP; Harrison Smith limited for Minnesota. Both secondaries are HIGH-tier targets (MIN offense: inside seam/slot/underneath; CHI offense: deep/post-cross). John Ewing: 87% of money on the Over 48. Justin Jefferson's first-read share with Wentz in Week 1 was 53% (BettingPros) — Vikings will keep it simple and quick. **MIN +5.5.**

**PHI @ TEN (PHI −7, total 39.5).** Jonathan Greenard OUT for Philly. Three shows on Under 39.5. Titans are 7-point home dogs with a low total — a 7-point line in a sub-40 game makes a push very live. **Pass for the contest; Under 39.5 is the play elsewhere.**

**GB @ NYJ (GB −3.5, total 44.5).** Heavy rain forecast (heavy-rain unders 202–136 historically, Stick to the Model). Jets missing Minkah Fitzpatrick, Joseph Ossai, Omar Cooper Jr.; Lukas Van Ness questionable for GB. Market moved 4.5 → 3.5. **Lean NYJ +3.5 (alternate).**

**CAR @ ATL (CAR −2.5, total 43.5).** Michael Penix Jr. OUT, Tua doubtful → Cooper Rush expected. Split 4–4 on the side. Carolina allowed ~300 rushing yards in Week 1 → Bijan Robinson is the angle, not the spread. **Pass.**

**NO @ BAL (BAL −8.5, total 46.5).** Zay Flowers doubtful (hamstring), Ronnie Stanley and Trey Hendrickson questionable, CB T.J. Tampa OUT; Chris Olave questionable for NO. BAL 5–2 on the side, Unders from BettingPros/Action. **BAL as a teaser leg, not a contest pick.**

**CIN @ HOU (HOU −2.5, total 45.5).** Joe Burrow questionable (back). Nico Collins OUT, Tank Dell OUT, Jadeveon Clowney OUT. 9–2 for Houston incl. BettingPros' survivor show. **HOU −2.5 if Burrow is limited or out.**

**CLE @ TB (TB −8.5, total 41.5).** Deshaun Watson starts for Cleveland; Tyson Campbell questionable. BettingPros survivor consensus on TB. **Alternate / teaser leg.**

**PIT @ NE (NE −5.5 contest / −5 market, total 41.5).** Steelers CB Joey Porter Jr. OUT, Michael Pittman Jr. and Troy Fautanu questionable; NE LT Dametrious Crownover OUT, Carlton Davis questionable. NE has 3+ extra rest after the Wednesday opener. **Split — PIT +5.5 only as an alternate.**

**LV @ LAC (LAC −6.5, total 43.5).** Brock Bowers doubtful, Aidan O'Connell questionable; LAC: Ladd McConkey questionable, Trey Pipkins and Elijah Molden OUT. BettingPros: Chargers have little home-field vs. Raiders. **Pass.**

**JAX @ DEN (DEN −2.5, total 45.5).** Denver's Marvin Mims OUT, RJ Harvey questionable; Jaguars' Brian Thomas Jr., Jakobi Meyers, LeQuint Allen Jr. all questionable. 11 sources on Denver — the week's strongest side consensus. **DEN −2.5.**

**WAS @ DAL (DAL −4.5 contest / −4 market, total 50.5).** Chig Okonkwo OUT for WAS; Malik Hooker OUT for DAL. Dallas qualifies for Lock & Cash's "Silencer System" (favored in W1, lost outright, high total). Kalshi prices WAS +4.5 at ~52.5%. **WAS +4.5 alternate.**

**SEA @ ARI (SEA −3.5 contest / −4 market, total 41).** Sam Darnold OUT → Drew Lock; Zach Charbonnet OUT. ARI: CB Garrett Williams OUT, James Conner OUT. ARI has 5 backers — at +4/+4.5, not +3.5. **Pass in the contest.**

**MIA @ SF (SF −13.5, total 44.5).** Chop Robinson and Ronnie Harrison OUT for MIA. No show we track took SF on the spread. **MIA +13.5.**

**IND @ KC (KC −6.5, total 46.5, SNF).** KC S Chamarri Conner OUT, CB Mansoor Delane questionable; IND WR Ashton Dulin OUT. Kalshi has KC −6.5 at a coin flip. Split 8–6. **Pass; see props (Daniel Jones Under 32.5 attempts).**

**NYG @ LAR (LAR −7 contest / −7.5 market, total 48, MNF).** Puka Nacua questionable; Kam Curl and Kamren Kinchens questionable. NYG: Deonte Banks and Greg Newsome questionable, Korie Black OUT, LT Andrew Thomas and Francis Mauigoa questionable. Rams are 0–1 after the Melbourne opener; Giants are off an emotional upset of Dallas (Covers: letdown spot). **LAR −7.**

---

## 5. Strategic Playbook — Week 2 Rules
1. **Take free points first.** MIN +5.5 (+1.0) and LAR −7 (+0.5) are the only Top-5 picks where the contest number beats the market; that was the one edge that won in Week 1.
2. **Don't pay a key number you don't own.** ARI +3.5 and PHI −7 look similar to the market plays but sit on the wrong side of 4 and 7.
3. **Injury gate before lock:** HOU pick is conditional on Burrow; LAR pick assumes Nacua plays or the NYG OL is compromised.

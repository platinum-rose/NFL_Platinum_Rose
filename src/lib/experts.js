...
export const EXPERTS = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // ARTICLE & PROP SPECIALISTS (id 38–46)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    ...
    sourceType: 'rss_article',
    ingestStatus: 'active',
    note: 'VSiN senior betting analyst specializing in player props, spreads, and OptaAI model edges.',
    aliases: ['zachary cohen', 'zach cohen', 'cohen'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    ...
    sourceType: 'rss_article',
    ingestStatus: 'active',
    note: 'VSiN managing editor specializing in First TD scorers, situational angles, and game totals.',
    aliases: ['adam burke', 'burke'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    ...
    sourceType: 'rss_article',
    ingestStatus: 'active',
    note: 'VSiN analyst and "The Guru" specializing in player props and fantasy-betting crossovers.',
    aliases: ['john hansen', 'the guru', 'hansen'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    ...
    sourceType: 'rss_article',
    ingestStatus: 'active',
    note: 'BettingPros player prop specialist covering receiving and rushing milestones.',
    aliases: ['travis pulver', 'pulver'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    ...
    sourceType: 'rss_article',
    ingestStatus: 'active',
    note: 'BettingPros analyst covering high-volume receivers and SGPs.',
    aliases: ['phil wood', 'wood'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    ...
    sourceType: 'rss_article',
    ingestStatus: 'active',
    note: 'BettingPros touchdown prop specialist covering First TD and Anytime TD markets.',
    aliases: ['mike spector', 'spector'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    id: 44,
    name: 'Richard Janvrin',
    source: 'BettingPros',
    sourceType: 'rss_article',
    ingestStatus: 'active',
    note: 'BettingPros author focusing on running back touchdown props and goal-line usage.',
    aliases: ['richard janvrin', 'janvrin'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    ...
    sourceType: 'rss_article',
    ingestStatus: 'active',
    note: 'BettingPros analyst covering rushing lines and workhorse backfield volume.',
    aliases: ['steve krebs', 'krebs'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    ...
    sourceType: 'rss_article',
    ingestStatus: 'active',
    note: 'Sharp Football Analysis writer focusing on quantitative SGPs and target shares.',
    aliases: ['curtis hirsch', 'hirsch'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // TWITTER / X EXPERTS & SHARPS (id 47–57)
  // ═══════════════════════════════════════════════════════════════════════════

  {
    id: 47,
    name: "What's Up P (@propswithicy)",
    source: 'Twitter/X',
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'Twitter sharp (@propswithicy) specializing in QB mobility, rushing props, and unit-weighted plays.',
    aliases: ['propswithicy', 'whatsup p', "what's up p", '@propswithicy'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    ...
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'Twitter handicapper (@Zl0ckz21_) covering primetime best bets, player props, and PrizePicks slips.',
    aliases: ['zl0ckz21_', 'zr21', '@zl0ckz21_'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    id: 49,
    name: "Dan's AI Sports Picks (@DanGambleAI)",
    source: 'Twitter/X',
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'Twitter sports model (@DanGambleAI) specializing in plus-money props and milestone ladders.',
    aliases: ['dangambleai', "dan's ai", 'dan gamble ai', '@dangambleai'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    id: 50,
    name: 'Joe Holka (@thejoeholkashow)',
    source: 'Twitter/X',
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'Host of The Joe Holka Show (@thejoeholkashow) specializing in parlay anchors and target volume.',
    aliases: ['thejoeholkashow', 'joe holka', 'holka', '@thejoeholkashow'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    id: 51,
    name: 'Sal Bets (@salbets_)',
    source: 'Twitter/X',
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'Twitter analyst (@salbets_) covering curated parlay slips, DFS discount lines, and opening slates.',
    aliases: ['salbets_', 'sal bets', 'salbets', '@salbets_'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    id: 52,
    name: 'Ben Fawkes (@BFawkes22)',
    source: 'Twitter/X',
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'Betting industry reporter (@BFawkes22) covering sports book handle, ticket splits, and market moves.',
    aliases: ['bfawkes22', 'ben fawkes', 'fawkes', '@bfawkes22'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    id: 53,
    name: 'John Ewing (@johnewing)',
    source: 'Twitter/X',
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'BetMGM PR data analyst (@johnewing) reporting most-bet player props and ticket counts.',
    aliases: ['johnewing', 'john ewing', 'ewing', '@johnewing'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    id: 54,
    name: 'Cody Brown Bets (@CodyBrownBets)',
    source: 'Twitter/X',
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'Twitter handicapper (@CodyBrownBets) specializing in mispriced lines and volume overs.',
    aliases: ['codybrownbets', 'cody brown', 'cody brown bets', '@codybrownbets'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    id: 55,
    name: 'Invisible Insider (@invisiblestats)',
    source: 'Twitter/X',
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'Twitter market intelligence account (@invisiblestats) tracking reverse line movement and sharp money vs public handle.',
    aliases: ['invisiblestats', 'invisible insider', '@invisiblestats'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    id: 56,
    name: 'Harry Lock Picks (@HarryLockPicks)',
    source: 'Twitter/X',
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'Twitter handicapper (@HarryLockPicks) tracking multi-year historical parlay trends.',
    aliases: ['harrylockpicks', 'harry lock picks', '@harrylockpicks'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },
  {
    id: 57,
    name: 'Evan Silva (@evansilva)',
    source: 'Twitter/X',
    sourceType: 'tweet',
    ingestStatus: 'active',
    note: 'Co-founder Establish The Run (@evansilva) providing deep usage analytics, scheme matchups, and player evaluations.',
    aliases: ['evansilva', 'evan silva', 'silva', '@evansilva'],
    isShow: false,
    record: '0-0',
    lastWeek: '0-0',
  },

...
- Current caveat: the current worktree training-camp latest snapshot is an all-32 empty placeholder. Restore the verified 16-item snapshot or approve a fresh live RSS scout before model synthesis.

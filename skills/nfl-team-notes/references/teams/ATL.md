...
- **Division:** NFC South
- **Stadium:** Mercedes-Benz Stadium — Dome, Atlanta, GA
- **Climate:** Dome venue. No weather factor.
- **Home-field strength:** Moderate. Good dome crowd for big games.

## Offensive Identity

Kirk Cousins era: methodical passer, Rachaad White run complement. Kyle Pitts usage key variable.
...
Raheem Morris: aggressive, high-pressure scheme. Jessie Bates III coverage anchor.
> ⚠️ *Contains named-player references — not re-verified against current roster. Cross-check before relying on this for a specific player's current team (nfl-roster-refresh-audit-2026-07).*
...
- **Home ATS:** No data
- **Road ATS:** No data
- **Situational notes:** Watch Cousins health — line moves dramatically. Dome team = stable weather-adjusted ATS.
...
Cousins ACL history — injury news creates sharp line movement. Monitor weekly injury report closely.

## Coaching Profile

See `NFL/Reference/CoachTendencies.md` — Raheem Morris.

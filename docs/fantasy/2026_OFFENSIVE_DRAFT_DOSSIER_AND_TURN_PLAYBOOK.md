# ⚡ 2026 Master Offensive Draft Dossier & Pick 3 (1.03) Turn Playbook

**Target Audience:** Draft War Room, Live In-Draft Execution & Decision Engine  
**League Context:** Rose Bowl (12-team redraft, **Pick #3 (1.03)**, Full PPR, zero kickers, 3 starting IDP LBs, 1 IR slot)  
**Roster Directive:** Secure 1 Elite Anchor WR/RB at 1.03, exploit the 5-pick rapid turnaround across early turns, trigger the IDP LB1 run at Turn 8 (Round 8.10/9.03), and lock in high-efficiency offensive depth.

> **Data Sourcing Transparency**
>
> The player **identities, draft ranks, and team affiliations** in this document are CSV-verified against `docs/fantasy/2026_Rose_Bowl_Custom_Rankings.csv` (commit `b6d8471`).
>
> Trench line-of-scrimmage metrics (Run Block Z, Pass Block Z, Composite Rank) are verified against `data/intel/bettorday_trench_ratings_2026.json` (BettorDay 2026 baseline dataset).
>
> All role projections, target volumes, and scheme classifications are informed editorial context for draft-room decisions.

---

## 🎯 Pick 3 (1.03) Master Turn Blueprint

In a 12-team snake draft from **Slot 3**, you experience rapid **5-pick turnarounds** at the top of odd rounds, followed by **19-pick waits** between turns:

| Turn | Round & Pick | Overall Pick | Strategic Objective & Target Window | Primary Roster Target |
|---|---|---|---|---|
| **Turn 1** | **1.03** | **Pick #3** | **Tier 1 Alpha Anchor** — Lock elite cornerstone (Gibbs, Bijan, Chase, Nacua, or CMC). | **RB1 or WR1** |
| **Turn 2** | **2.10** | **Pick #22** | **Hero RB / Elite WR2 Anchor** — Exploit elite drop-off before 5-pick turn. | **WR / RB / Elite TE** |
| **Turn 3** | **3.03** | **Pick #27** | **Rapid Turn Strike (5 picks later)** — Lock Bowers/McBride or high-volume WR2/RB2. | **WR / RB / Elite TE / QB** |
| **Turn 4** | **4.10** | **Pick #46** | **Trench-Boosted Backfield / Target Hog WR** — Exploit BettorDay top blocking units. | **WR / RB** |
| **Turn 5** | **5.03** | **Pick #51** | **Rapid Turn Strike (5 picks later)** — High-ceiling Flex, elite rookie breakout, or Tyler Warren/Drake Maye. | **WR / RB / TE / QB** |
| **Turn 6** | **6.10** | **Pick #70** | **High-Volume WR3 / QB Value Run** — Jayden Daniels, Jalen Hurts, or Odunze/Watson. | **WR / QB / TE** |
| **Turn 7** | **7.03** | **Pick #75** | **Anchor Flex / TE Value** — Tucker Kraft, Kyle Pitts, Sam LaPorta, or Dak Prescott. | **TE / WR / RB** |
| **Turn 8** | **8.10** | **Pick #94** | 🚨 **THE IDP TRIGGER WINDOW (LB1)** — Roquan Smith (`#85`), Foyesade Oluokun (`#88`), Fred Warner (`#92`), Zaire Franklin (`#96`). | **IDP LB Starter #1** |
| **Turn 9** | **9.03** | **Pick #99** | **Rapid Turn Strike (5 picks later)** — IDP LB2 consolidation or high-upside offensive weapon (Michael Pittman `#99`, Blake Corum `#103`). | **IDP LB2 or WR/RB** |
| **Turn 10** | **10.10** | **Pick #118** | **IDP LB2 Lock-in** — Jack Campbell (`#100`), Jamien Sherwood (`#104`), Daiyan Henley (`#108`), T.J. Edwards (`#112`). | **IDP LB Starter #2** |
| **Turn 11** | **11.03** | **Pick #123** | **Rapid Turn Strike** — High-ceiling offensive stash or IDP LB3 lock. | **WR / RB or IDP LB3** |
| **Turn 12** | **12.10** | **Pick #142** | **IDP LB3 Lock-in** — Azeez Al-Shaair (`#136`), Ernest Jones IV (`#140`), Devin Bush (`#144`). | **IDP LB Starter #3** |
| **Turn 13** | **13.03** | **Pick #147** | **Rapid Turn Strike** — Complete 3-IDP starting lineup. Zero bench IDPs. | **IDP LB3 / Offensive Stash** |
| **Turn 14+** | **14.10+** | **Picks 166+** | **Offensive Lotteries & IR Stashes** — Handcuffs, rookie sleepers, Josh Jacobs (`#57`) IR stash if slipped. | **High-Ceiling Bench** |

---

## ⚡ Turn-by-Turn Decision Trees & Strategies

### Turn 1 — Pick #3 (1.03)
* **Context:** The top 2 picks are almost certainly two of Jahmyr Gibbs, Bijan Robinson, or Ja'Marr Chase.
* **If Bijan Robinson or Jahmyr Gibbs is available:** Draft immediately. Secures an elite 300+ touch bellcow dual-threat anchor in a top-tier scoring offense.
* **If both RBs go 1.01 & 1.02:** Draft **Ja'Marr Chase (#3)** or **Puka Nacua (#4)**. Secures the unquestioned WR1 target alpha in Full PPR.
* **Trench Edge:** If selecting Nacua (#4), LAR boasts the **#1 overall trench composite** (+2.71 run block z-score, elite play-action).

### Turn 2 & Turn 3 — Picks #22 & #27 (2.10 & 3.03)
* **The 5-Pick Window:** You will pick at #22, wait only 5 selections (picks #23, 24, 25, 26), and pick again at #27.
* **Target Philosophy:** Build a 2-RB / 1-WR or 1-RB / 2-WR foundation.
* **Elite Targets at Pick #22:**
  - **Josh Allen (#21 QB):** If aiming for elite quarterback cheat-code.
  - **Brock Bowers (#22 TE):** Generational positional advantage at tight end.
  - **Drake London (#20 WR) / A.J. Brown (#19 WR):** High-volume WR alphas.
  - **Omarion Hampton (#15 RB) / Derrick Henry (#16 RB) / Ashton Jeanty (#17 RB):** *(Note: Jeanty carries BettorDay high-ankle injury flag)*.
* **Elite Targets at Pick #27:**
  - **Trey McBride (#25 TE):** Dominant 130-target middle-of-field weapon.
  - **Nico Collins (#24 WR) / Chris Olave (#26 WR) / Malik Nabers (#27 WR) / Rashee Rice (#28 WR):** Target monster WR2 tier.
  - **Kyren Williams (#29 RB):** Running behind the NFL's #1 run-blocking unit (LAR +2.71z).

### Turn 4 & Turn 5 — Picks #46 & #51 (4.10 & 5.03)
* **The 5-Pick Window:** Pick at #46, wait 5 selections, pick at #51.
* **Target Philosophy:** Exploit offensive line advantages and lock in high-ceiling WR/RB depth.
* **Elite Targets at Pick #46 & #51:**
  - **Lamar Jackson (#37 QB):** Elite Konami Code MVP dual-threat upside if slipping.
  - **Colston Loveland (#40 TE):** Chicago's athletic mismatch weapon.
  - **Ladd McConkey (#43 WR):** Jim Harbaugh's primary target separator in LA.
  - **Jaylen Waddle (#46 WR):** Denver's new perimeter speed merchant.
  - **Bucky Irving (#47 RB) / D'Andre Swift (#44 RB):** Explosive dual-threat rushers with high receiving involvement.
  - **Davante Adams (#50 WR):** Teaming with Nacua in McVay's offense.
  - **Tyler Warren (#51 TE) / Drake Maye (#52 QB):** Ascending franchise cornerstones.

### Turn 6 & Turn 7 — Picks #70 & #75 (6.10 & 7.03)
* **The 5-Pick Window:** Pick at #70, wait 5 selections, pick at #75.
* **Target Philosophy:** Finalize your flex spots and target high-efficiency QB/TE value before the IDP rush.
* **Elite Targets at Pick #70 & #75:**
  - **Jayden Daniels (#62 QB) / Jalen Hurts (#63 QB):** Elite rushing floor quarterbacks.
  - **Tucker Kraft (#70 TE) / Kyle Pitts Sr. (#71 TE) / Sam LaPorta (#73 TE):** Top-tier tight end value tier.
  - **Christian Watson (#68 WR) / Rome Odunze (#60 WR) / Carnell Tate (#74 WR):** High-efficiency perimeter receivers.
  - **Dak Prescott (#75 QB):** High-volume passing ceiling in Dallas.

### Turn 8 & Turn 9 — Picks #94 & #99 (8.10 & 9.03) — 🚨 THE IDP TRIGGER WINDOW
* **The Strategic Mandate:** In this 3-IDP format, **Linebacker 1 must be drafted at Turn 8 (Pick #94)**.
* **Top Targets:**
  - **Carson Schwesinger (#85 LB):** CLE Green Dot 3-down alpha.
  - **Cedric Gray (#89 LB):** TEN Green Dot leader.
  - **Zack Baun (#93 LB):** PHI Fangio blitz/tackle machine (+2.12 Pass Block team trench).
  - **Jordyn Brooks (#97 LB):** MIA 140+ tackle floor.
* **At Turn 9 (Pick #99):** Double-tap IDP LB2 (Jack Campbell `#100`, Jamien Sherwood `#104`) or grab sliding offensive value (Michael Pittman `#99`, Blake Corum `#103`).

# Projected Starters Snapshot - 2026-09-11
...
Season: 2026
Generated: 2026-09-11T15:02:00.678Z
Players: 113 | Teams with signals: 30 | Manual rows: 0 | Estimated rows: 113
...
| ATL | estimated_from_local_starter_language | 2 | manual all-position depth chart; independent source confirmation |
| BAL | estimated_from_local_starter_language | 4 | manual all-position depth chart; independent source confirmation |
| BUF | estimated_from_local_starter_language | 1 | manual all-position depth chart; independent source confirmation; Connor McGovern: withheld pending confirmation |
| CAR | estimated_from_local_starter_language | 3 | manual all-position depth chart; independent source confirmation |
| CHI | estimated_from_local_starter_language | 4 | manual all-position depth chart; independent source confirmation |
| CIN | estimated_from_local_starter_language | 4 | manual all-position depth chart; independent source confirmation |
| CLE | estimated_from_local_starter_language | 7 | manual all-position depth chart; independent source confirmation |
| DAL | estimated_from_local_starter_language | 5 | manual all-position depth chart; independent source confirmation |
| DEN | estimated_from_local_starter_language | 5 | manual all-position depth chart; independent source confirmation |
| DET | estimated_from_local_starter_language | 5 | manual all-position depth chart; independent source confirmation |
| GB | estimated_from_local_starter_language | 3 | manual all-position depth chart; independent source confirmation; Micah Parsons: conflicted team assignment |
| HOU | estimated_from_local_starter_language | 2 | manual all-position depth chart; independent source confirmation |
| IND | estimated_from_local_starter_language | 5 | manual all-position depth chart; independent source confirmation |
| JAX | estimated_from_local_starter_language | 4 | manual all-position depth chart; independent source confirmation |
| KC | estimated_from_local_starter_language | 3 | manual all-position depth chart; independent source confirmation |
| LAC | estimated_from_local_starter_language | 3 | manual all-position depth chart; independent source confirmation |
| LAR | estimated_from_local_starter_language | 1 | manual all-position depth chart; independent source confirmation |
| LV | estimated_from_local_starter_language | 7 | manual all-position depth chart; independent source confirmation |
...
| NE | needs_manual_depth_chart | 0 | verified all-position depth chart; manual source count reconciliation |
| NO | estimated_from_local_starter_language | 2 | manual all-position depth chart; independent source confirmation |
| NYG | estimated_from_local_starter_language | 2 | manual all-position depth chart; independent source confirmation |
| NYJ | estimated_from_local_starter_language | 5 | manual all-position depth chart; independent source confirmation |
| PHI | estimated_from_local_starter_language | 2 | manual all-position depth chart; independent source confirmation |
| PIT | needs_manual_depth_chart | 0 | verified all-position depth chart; manual source count reconciliation |
| SEA | estimated_from_local_starter_language | 1 | manual all-position depth chart; independent source confirmation |
| SF | estimated_from_local_starter_language | 1 | manual all-position depth chart; independent source confirmation |
...
| WAS | estimated_from_local_starter_language | 6 | manual all-position depth chart; independent source confirmation |
...
- Cooper Rush (QB): likely_starter_or_primary, starter 0.7, roster 0.66
  - Tags: starter | Impact: qb_major | Review: yes
  - Evidence: Rush took all of the first-team reps at Thursday's practice while Tua Tagovailoa (oblique) was unable to participate, Marc Raimondi of ESPN.com reports.
- Jack Strand (QB): roster_depth_signal, starter 0.42, roster 0.6
  - Tags: roster_signal | Impact: qb_major | Review: yes
  - Evidence: Strand is one of four quarterbacks who made Atlanta's 53-man roster, Will McFadden of the team's official site reports.
...
- KC Concepcion (WR): likely_starter_or_primary, starter 0.7, roster 0.66
  - Tags: starter | Impact: skill_major | Review: yes
  - Evidence: Concepcion told reporters after Wednesday's practice that he's looking forward to carrying his strong play in training camp into the regular season, starting with the Browns' Week 1 clash against the Jaguars on Sunday, Sept. 13, Chris Easterling of the Akron Beacon Journal reports.
...
- Malik Davis (RB): likely_starter_or_primary, starter 0.78, roster 0.74
  ...
  - Evidence: Davis remains as the top reserve running back in Dallas behind starter Javonte Williams following the reported cuts of Jaydon Blue and Phil Mafah, Patrik Walker of the Cowboys' official site reports.
...
- Stetson Bennett IV (QB): competition_or_rotation, starter 0.5, roster 0.6
  - Tags: competition | Impact: qb_major | Review: yes
  - Evidence: Bennett is set to work as the Rams' backup quarterback behind Matthew Stafford on Thursday versus San Francisco, Nate Atkins of The Athletic reports.
...
- KhaDarel Hodge (WR): roster_depth_signal, starter 0.42, roster 0.6
  - Tags: roster_signal | Impact: skill_major | Review: yes
  - Evidence: The 49ers elevated Hodge from the practice squad to the active roster for the team's Week 1 game against the Rams in Melbourne, Australia.
